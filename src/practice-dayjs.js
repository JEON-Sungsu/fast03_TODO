...
export const runPracticeDayjs = () => {
    ...
    // );
    // console.log('4. get year', dayjs().get('year'));
    // console.log('5. get month', dayjs().get('month')); // 0~11(1월~12월)
    // console.log('6. get date', dayjs().get('date'));
    // console.log('7. get day', dayjs().get('day')); // 0:일 ~ 6:토
    // console.log('8. get second', dayjs().get('second'));
    // console.log(
    //     '9. add hour',
    ...
    // console.log(
    //     '11. startOf',
    //     dayjs(now).startOf('month').format('YYYY.MM.DD')
    // );
    ...
    // console.log(
    //     '19. isSameOrBefore',
    //     dayjs(aDate).isSameOrBefore(bDate, 'date')
    // );
